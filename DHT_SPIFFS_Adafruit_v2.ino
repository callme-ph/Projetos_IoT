...
const char* mqtt_keyAdafruitIO = "aio_csfX21983J3rV6tKOEUpUonf8Ut3";
...
void publicarDados(String s_str){
  ...
  for(int i = 0; i < s_str.length(); i++){
    ...
    if( pos == -1 ){
      Serial.println("Erro indexOf");
      return;   
    }

    strcpy(value, (s_str.substring(i, pos)).c_str());
    ...
    /*strcpy(resultado, value);

    Serial.print("String resultado com um único dado a ser publicado: ");
